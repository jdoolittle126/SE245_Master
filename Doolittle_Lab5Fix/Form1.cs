...
namespace Doolittle_Lab5
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button_submit_Click(object sender, EventArgs e)
        {
            ...
            person = new Person(textbox_name_first.GetText(), textbox_name_middle.GetText(), textbox_name_last.GetText(), textbox_street1.GetText(), 
                textbox_street2.GetText(), textbox_city.GetText(), textbox_state.GetText(), textbox_zip.GetText(), textbox_phone.GetText(), textbox_email.GetText());
