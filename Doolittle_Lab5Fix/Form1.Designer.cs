namespace Doolittle_Lab5
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textbox_phone = new HintTextBox("(000) 000-0000");
            this.textbox_email = new HintTextBox("johndoe@example.com");
            this.textbox_zip = new HintTextBox("01234");
            this.textbox_state = new HintTextBox("RI");
            this.textbox_city = new HintTextBox("Providence");
            this.textbox_street2 = new HintTextBox("Apartment 2E");
            this.textbox_street1 = new HintTextBox("123 Example St.");
            this.textbox_name_last = new HintTextBox("Doe");
            this.textbox_name_middle = new HintTextBox("Michael");
            this.textbox_name_first = new HintTextBox("John");
